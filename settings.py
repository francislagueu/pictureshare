...
MEDIA_ROOT = os.path.join(os.path.expanduser('~'), 'django/storage')

# URL that handles the media served from MEDIA_ROOT. Make sure to use a
# trailing slash.
# Examples: "http://media.lawrence.com/media/", "http://example.com/media/"
MEDIA_URL = 'http://ec.yifanyin.info' + (':8000' if DEBUG else '') + '/storage/'
...
SECRET_KEY = 'd8@@d*1vn@p2uen%aw-)8_ydy1olitmi3ka74q)#9dbfx8!6ib'
